...
import Plugins.jxmap.swingx.mapviewer.bmng.CylindricalProjectionTileFactory;
...
//				Point2D centerpos = map.getTileFactory().geoToPixel(mapCenterPosition, map.getZoom());
	...
	private void initComponents()
	{
		...
		mainMap = new Plugins.jxmap.swingx.JXMapViewer();
		miniMap = new Plugins.jxmap.swingx.JXMapViewer();
	...
	private Plugins.jxmap.swingx.JXMapViewer mainMap;
	private Plugins.jxmap.swingx.JXMapViewer miniMap;
